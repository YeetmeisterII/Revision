...
def links():
    context = [
        ...
        },
        {
            "topic_name": "3D Space",
            "link_data": [
                {"name": "Planes", "viewname": "maths:topic_page", "args": ["3d_space", "planes"]},
                {"name": "Intersection of Planes", "viewname": "maths:topic_page",
                 "args": ["3d_space", "intersection_of_planes"]},
                {"name": "Lines", "viewname": "maths:topic_page", "args": ["3d_space", "lines"]},
                {"name": "Points, Lines and Planes", "viewname": "maths:topic_page",
                 "args": ["3d_space", "points_lines_and_planes"]},
            ]
        },
        {
        ...
        {
            "topic_name": "Modelling with Algorithms",
            "link_data": [
                {"name": "Working with Graphs", "viewname": "maths:topic_page",
