...
class TestChrome(TestCase):
    ...
    def test_index_loaded(self):
        self.driver.get("http://localhost:8000/computer_science/")
    ...
    def test_topic_page_loaded(self):
        self.driver.get("http://localhost:8000/computer_science/")
        self.driver.find_element_by_id("nav_local_button_2").click()
        self.driver.find_element_by_link_text("Structure and Function of the Processor").click()
        self.assertEqual(self.driver.title, "Structure and Function")
